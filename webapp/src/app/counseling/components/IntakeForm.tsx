    ...
    >
      ...
      <div className="w-full max-w-7xl mx-auto flex-1 flex flex-col justify-center">
        <div className="text-center mb-10 mt-6">
          ...
          <p className="text-xs font-semibold text-slate-600 mt-2 tracking-wide max-w-2xl mx-auto">
        ...
        <div className="flex items-center justify-between max-w-3xl mx-auto w-full mb-12 text-xs font-bold text-slate-700 dark:text-slate-500 px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="md:col-span-2 space-y-2">
                ...
                <input 
                  ...
                  className={`w-full bg-slate-50 dark:bg-[#050b1d] border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3.5 text-sm text-slate-800 dark:text-slate-100 focus:outline-none focus:border-emerald-500 dark:focus:border-[#00c2a8] transition-all font-medium ${currentUser ? "opacity-60 bg-slate-100 dark:bg-slate-900 cursor-not-allowed" : ""}`} 
                />
